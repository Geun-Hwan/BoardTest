...
<div align="center">
	<h2>게시글 보기</h2>
		<table style="width:600; background-color:skyblue;" border="1">
			<tr height="40">
			...
			<tr height="40">
				<td align="center" colspan="4">
					<input type="button" value="답글쓰기" onclick="location.href='BoardReWriteFrom.jsp?num=<%=bean.getNum()%>&ref=<%=bean.getRef()%>&re_step=<%=bean.getRe_step()%>&re_level=<%=bean.getRe_level()%>'">
